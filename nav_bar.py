...
.site-topnav {
  ...
  margin: 0; padding: 0 32px; min-height: 70px;
...
.nav-logo { width: 32px; height: 32px; display: block; flex-shrink: 0; }
.nav-brand-text {
...
.nav-links a, .nav-links span.active {
  color: #4a5568; text-decoration: none; font-weight: 600; font-size: 14.5px;
...
.lang-toggle-btn {
  ...
  color: var(--text-secondary, #4a5568); font-size: 13px; font-weight: 700;
...
@media (max-width: 780px) {
  body { padding-top: 112px; }  /* 兩行版放大後的高度，實測後校正 */
  ...
  .nav-links a, .nav-links span.active { padding: 7px 13px; font-size: 13.5px; }
}
