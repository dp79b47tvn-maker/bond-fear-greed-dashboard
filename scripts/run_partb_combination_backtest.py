...
<title>Part B｜11 因子 2,047 種組合爆破與樣本外驗證報告</title>
<style>
...
<div class="page-container" style="max-width: 1200px; margin: 0 auto; padding: 24px 16px;">
  ...
  <header style="margin-bottom: 32px;">
    <h1 style="font-size: 26px; font-weight: 700; margin-bottom: 8px;">Part B｜11 因子 2,047 種組合爆破與 Walk-Forward 樣本外驗證報告</h1>
